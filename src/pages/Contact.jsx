    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-20 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {/* Email Card */}
          <a
            href="mailto:yumba.work846@gmail.com"
            className="bg-gray-800 p-6 rounded-lg hover:bg-gray-700 transition-all duration-300 border border-gray-700 hover:border-blue-500 hover:shadow-[0_0_20px_rgba(59,130,246,0.5)]"
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-400 break-all">yumba.work846@gmail.com</p>
            </div>
          </a>

          {/* GitHub Card */}
          <a
            href="https://github.com/YumbaCanCan"
            target="_blank"
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-400">github.com/YumbaCanCan</p>
            </div>
          </a>

          {/* WhatsApp Card */}
          <a
            href="https://wa.me/260973602926"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gray-800 p-6 rounded-lg hover:bg-gray-700 transition-all duration-300 border border-gray-700 hover:border-blue-500 hover:shadow-[0_0_20px_rgba(59,130,246,0.5)]"
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-400">+260 9736 02926</p>
            </div>
          </a>
        </div>
